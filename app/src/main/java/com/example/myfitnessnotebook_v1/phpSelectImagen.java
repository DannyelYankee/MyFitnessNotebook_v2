...
public class phpSelectImagen extends Worker {
    miBD gestorBD;
    public phpSelectImagen(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String server = "http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/djuape001/WEB/selectImagen.php";
